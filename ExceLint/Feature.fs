module Feature
    ...
    | SquareVector of double*double*double*double*double*double
        override self.ToString() : string =
            ...
            | ResultantVectorWithConstant(x,y,z,c) ->
        ...
        member self.MeanFoldDefault : Countable =
            ...
            | ResultantVectorWithConstant _ -> ResultantVectorWithConstant(0.0,0.0,0.0,0.0)
        member self.Add(co: Countable) : Countable =
            ...
            | ResultantVectorWithConstant(x1,y1,z1,c1),
                ResultantVectorWithConstant(x2,y2,z2,c2) -> ResultantVectorWithConstant(x1+x2, y1+y2, z1+z2, c1+c2)
        ...
        member self.Negate : Countable =
            ...
            | SquareVector(dx,dy,dz,x,y,z) ->
                SquareVector(-dx,-dy,-dz,-x,-y,-z)
            | ResultantVectorWithConstant(x,y,z,c) -> ResultantVectorWithConstant(-x,-y,-z,-c)
        member self.ScalarDivide(d: double) : Countable =
            ...
            | ResultantVectorWithConstant(x,y,z,c) ->
                ResultantVectorWithConstant(x / d, y / d, z / d, c / d)
        member self.VectorMultiply(co: Countable) : double =
            ...
            | ResultantVectorWithConstant(x1,y1,z1,c1),
                ResultantVectorWithConstant(x2,y2,z2,c2) ->
        ...
        member self.Sqrt : Countable =
            ...
            | ResultantVectorWithConstant(x,y,z,c) ->
                ResultantVectorWithConstant(Math.Sqrt(x),Math.Sqrt(y),Math.Sqrt(z),Math.Sqrt(c))
        member self.Abs : Countable =
            ...
            | ResultantVectorWithConstant(x,y,z,c) ->
                ResultantVectorWithConstant(Math.Abs(x),Math.Abs(y),Math.Abs(z),Math.Abs(c))
