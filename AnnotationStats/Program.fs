...
let main argv = 
    ...
    printfn "There are %A true ref bugs in the ExceLint corpus." excelint_num_TP
    printfn "ExceLint found %A more true ref bugs than CUSTODES." (excelint_num_TP - custodes_num_TP)
